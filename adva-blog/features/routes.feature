Feature: Routes
  Scenario: Routes
    ...
    Then the following routes should be recognized:
      ...
      | GET    | /blogs/1.rss                              | posts               | index   | format: rss, blog_id: 1                               |
      | GET    | /blogs/1/2010.rss                         | posts               | index   | format: rss, blog_id: 1, year: 2010                   |
      | GET    | /blogs/1/2010/1.rss                       | posts               | index   | format: rss, blog_id: 1, year: 2010, month: 1         |
      | GET    | /blogs/1/2010/1/1.rss                     | posts               | index   | format: rss, blog_id: 1, year: 2010, month: 1, day: 1 |
      | GET    | /blogs/1/2010/1/1/foo.rss                 | posts               | show    | format: rss, blog_id: 1, permalink: 2010/1/1/foo      |
