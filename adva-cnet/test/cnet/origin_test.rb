...
#       attr_reader :db, :origin
# 
#       def setup
#         @db = Adva::Cnet::Connection.new(tmp_db_path.join('origin.test.sqlite3'))
#         db.attach_databases
#         @origin = db.origin
# 
...
#       def teardown
#         db.close
#         FileUtils.rm(tmp_db_path.join('origin.test.sqlite3')) rescue Errno::ENOENT
#       end
# 
